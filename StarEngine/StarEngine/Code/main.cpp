...
void render(Model &m,Camera *camera,LightMgr &light)
{
...
int main()
{
	...
	LightMgr lightmgr;
	lightmgr.CreateLight(LightType::Directional, glm::vec3(1, -1, 1), new Color(1, 1 ,1, 1), glm::vec3(1, 1, 1), 0, 0);
